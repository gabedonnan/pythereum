...
class MyTestCase(unittest.TestCase):
    def test_block_num(self):
        self.assertIsInstance(erpc_ws.get_block_number(), int)  # add assertion here

    def test_transaction_count(self):
        self.assertIsInstance(erpc_ws.get_transaction_count("0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"), int)
    ...
    def test_get_block_by_hash(self):
        print(erpc.get_block_by_hash("0xdc0818cf78f21a8e70579cb46a43643f78291264dda342ae31049421c82d21ae", True))
        self.assertIsInstance(erpc_ws.get_block_by_hash("0xdc0818cf78f21a8e70579cb46a43643f78291264dda342ae31049421c82d21ae", False), Block)

    def test_get_block_by_number(self):
        self.assertIsInstance(erpc_ws.get_block_by_number(17578346, False), Block)
        print(erpc.get_block_by_number(17578346, False))
